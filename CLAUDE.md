...
> **🏎️ 3-рівнева маршрутизація (економія токенів):**
> - **"Яку CRM для ніші X?"** → визнач нішу нижче → читай `00-overview.md` або нішевий файл
> - **"Розкажи про систему X" / "Для яких ніш підходить X?"** → читай `crm-selection/by-system/[система].md`
> - **"Порівняй топ-3 / яку обрати взагалі"** → читай `crm-selection/niches/00-INDEX.md` (мастер-таблиця)
> - **Глибоке питання по конкретній ніші** → читай сабфайл 01/02/03 у папці ніші

### → читай `crm-selection/by-system/[система].md`
розкажи про KeyCRM, для яких ніш підходить KeepinCRM, де використовують NetHunt, огляд Planfix по нішах, Perfectum для яких бізнесів, HubSpot ніші, Pipedrive де підходить, Odoo для кого, порівняй системи між собою, який бізнес обирає X

### → читай `crm-selection/niches/00-INDEX.md`
яку CRM обрати взагалі, мастер-таблиця ніш, топ CRM по всіх нішах, порівняй топ-3 для різних бізнесів, загальний огляд ринку CRM України
...
- 🎚 Команды по видео (договорённость): **«прочитай видео»** = только транскрипт (быстро, дёшево);
  **«просмотри видео»** = транскрипт + кадры с OCR. По умолчанию — «прочитай». (Деталь — `SKILL.md`, ANALYZE.)
