...
> Джерела (за пріоритетом): ChatGPT Deep Research 2026-06, Gemini Deep Research 2026-05, офіційна документація Odoo
> Актуальна версія продукту на 2026: **Odoo 19** (реліз вересень 2025)
...
Odoo — інтегрована модульна ERP/CRM-платформа. Офіційно: **15 млн користувачів**, **100+ тис. розробників**, **40+ тис. community apps**.
...
### 1.4 Тарифні плани (2026)

| Plan | Ціна (США, міс.) | Що включено |
|---|---|---|
| **One App Free** | $0 | 1 додаток, необмежено користувачів, тільки Odoo Online |
| **Standard** | ~$31.10/user | Всі додатки, Odoo Online, **без** кастомного коду та API |
| **Custom** | **$46.70–$58.40/user** | Всі додатки, Studio, multi-company, external API; Odoo Online / Odoo.sh / on-premise |

> Odoo.sh оплачується окремо (workers, storage, staging). Точні тарифи Odoo.sh в офіційному HTML не розкриваються — бюджетувати двома рядками: ліцензія Custom + hosting.

**Орієнтир ліцензійних витрат Custom/рік:**
- 5 users → ~$2,800–3,500/рік
- 25 users → ~$14,000–17,500/рік
- 100 users → ~$56,000–70,000/рік
*(не включає Odoo.sh, впровадження, міграцію даних, навчання, кастомний код)*
