...
- **Що це:** номерний Telegram і Viber — дозволяє **ініціювати** переписку першими з клієнтами
- Звичайні боти Telegram/Viber — тільки **відповідають** на вхідні; eChat — може писати першим
- **Підключення:** Крамниця → застосунок eChat
- **Реліз:** вебінар #10, серпень 2025

---

## LinkedIn-інтеграція

- Chrome-розширення партнера: додає кнопку «Створити контакт в Uspacy» на сторінці LinkedIn
- Опубліковано у Крамниці партнером (реальний кейс розробника)
- Приклад застосування мікрофронтенд-архітектури Uspacy для marketplace-застосунків
